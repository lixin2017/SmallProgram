public struct Complex
{
	...
	{
		Complex num1=new Complex(0,1);
		Complex num2=new Complex(3,4);
		

		Complex result=num1 ? num1+num2 :new Complex(0,0);   //- num1*5+num1*num2

		System.Console.WriteLine("First complex number is {0}",num1);
		System.Console.WriteLine("Second complex number is {0}",num2);
